...
class Tipos_postais_db(models.Model):
    ...
    def __str__(self):
        return "Tipo Postal: {}, Sigla: {}".format(self.classe_obj.nome_tipo, self.sigla_obj)
...
class Objetos_db(models.Model):
    ...
    classe_obj = models.ForeignKey(Tipos_postais_base, on_delete=models.PROTECT, verbose_name="Tipo")

    def __str__(self):
        return "Número do Objeto: {}, Destinatário: {}, Data de Inclusão: {} - {}".format(self.id, self.destinatario, self.data_inclusao, self.classe_obj.nome_tipo)